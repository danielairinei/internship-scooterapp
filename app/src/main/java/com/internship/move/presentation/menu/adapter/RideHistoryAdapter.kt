...
class RideHistoryAdapter : ListAdapter<RideHistoryItem, RideHistoryViewHolder>(RideHistoryItemDiffUtilCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RideHistoryViewHolder = RideHistoryViewHolder(
        ItemHistoryCardViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    )
