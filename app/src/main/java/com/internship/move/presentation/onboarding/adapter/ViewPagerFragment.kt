...
class ViewPagerFragment : Fragment(R.layout.item_onboarding_page) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val pagerItem: OnboardingViewPagerItem? = arguments?.getParcelable(KEY_ONBOARDING_PAGER_ITEM)
    ...
    companion object {
        ...
        fun newInstance(pagerItem: OnboardingViewPagerItem): ViewPagerFragment = ViewPagerFragment().apply {
